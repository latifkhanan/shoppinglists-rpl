...
<body>
    ...
    <div class="container">
        <h1>Edit Item dalam {{ $shoppingList->name }}</h1>

        <form method="POST" action="{{ route('shopping-lists.items.update', [$shoppingList, $item]) }}">
            @csrf
            @method('PUT')
            ...
            <div class="toggle-container">
                ...
                <label class="toggle-switch">
                    <input type="checkbox" id="is_purchased" name="is_purchased" value="1" {{ $item->is_purchased ? 'checked' : '' }}>
